...
export const MembershipContent3 = (nextStep: any) => {
    ...
    <div className='flex h-full'>
      ...
      <section className='h-full lg:w-1/2 w-full grid place-items-center'>
        <div className='mx-auto sm:w-1/2 w-full pt-4'>
          <div className='border rounded-md border-black hover:border-blue-400 hover:bg-blue-50 flex justify-center items-center py-2 mb-4 mx-8'>
        ...
        >
          ...
          {/*Email*/}
          <div
            className={`${'my-3 flex border rounded-xl hover:bg-[#D7DEED]'} ${
          ...
          {/*Password*/}
          <div
            className={`${'my-3 flex border rounded-xl relative hover:bg-[#D7DEED]'} ${
          ...
          >
            ...
            />
            <span
              className='icon flex items-center px-4 text-[#3B578E] hover:text-[#DB2323] active:text-[#201C44]'
