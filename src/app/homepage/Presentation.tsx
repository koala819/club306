...
export const Presentation = () => {
  ...
  //               Le club a été crée suite à un besoin exprimé par de nombreuses
  ...
  //         </div>
  //         <div className='w-1/2 flex justify-center items-center'>
  //           <button className='w-1/3 text-center bg-[#DB2323] inline-flex py-3 sm:px-5 rounded-lg items-center hover:bg-[#201C44] focus:outline-none'>
  //             <svg
  //               xmlns='http://www.w3.org/2000/svg'
  //               fill='currentColor'
  //               className='w-6 h-6 text-white hidden sm:block'
  //               viewBox='0 0 512 512'
  //             >
  //               <path d='M99.617 8.057a50.191 50.191 0 00-38.815-6.713l230.932 230.933 74.846-74.846L99.617 8.057zM32.139 20.116c-6.441 8.563-10.148 19.077-10.148 30.199v411.358c0 11.123 3.708 21.636 10.148 30.199l235.877-235.877L32.139 20.116zM464.261 212.087l-67.266-37.637-81.544 81.544 81.548 81.548 67.273-37.64c16.117-9.03 25.738-25.442 25.738-43.908s-9.621-34.877-25.749-43.907zM291.733 279.711L60.815 510.629c3.786.891 7.639 1.371 11.492 1.371a50.275 50.275 0 0027.31-8.07l266.965-149.372-74.849-74.847z'></path>
  //             </svg>
  //             <Link href='membership'>
  //               <span className='sm:ml-4 flex items-start flex-col leading-none sm:text-xs  text-[12px] text-white mb-1'>
  //                 Adhérer
  //               </span>
  //             </Link>
  //           </button>
          ...
          <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
            ...
            <div className='flex justify-center'>
              <button className='text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-[#DB2323] rounded text-lg'>
                <Link href='/club'>En savoir plus ...</Link>
              </button>
            </div>
          </div>
          <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6'>
