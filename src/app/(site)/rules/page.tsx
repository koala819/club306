    ...
    <div className="container mx-auto p-4">
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          obligatoire à chaque membre de l&apos;association. Il est rappelé que
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          <span style={{ fontWeight: 700 }}>Club306</span> et de mettre en avant
          une communauté.
        </p>
        <p>
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          sous sa propre responsabilité. Chaque membre reste seul responsable de
          ses actes et des dommages corporels et/ou matériels causés de son
          fait.
        </p>
      </section>
      <section className="mb-10 space-y-8">
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          <span style={{ fontWeight: 700 }}>Club306</span> pourra valider toute
          ...
          un délai défini, auprès du trésorier du club. Ces prestations pourront
          concerner la location de chambres d’hôtels, campings, gîtes, repas et
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          détérioration des rails de sécurité, des grillages, du revêtement du
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          lois en vigueur dans son pays d&apos;immatriculation, non prévue par
          le constructeur et/ou avec des pièces non homologuées, ou modification
          esthétiques lourdes, devront être signalées lors de
      ...
      <section className="mb-10 space-y-8">
        ...
        <ul className="space-y-4 mt-4 mb-4 ml-4 list-disc">
          ...
          <li>
            ...
            des présents statuts et du règlement). Dans tous les cas, la ou les
            cotisation(s) déjà payée(s) reste(nt) acquise(s) à
            l&apos;association.
          </li>
        </ul>
        <p>
      ...
      <section className="mb-10 space-y-8">
        ...
        <p>
          ...
          consultable à tout moment et par tout membre. Une notification de mise
          à jour sera envoyée à chaque membre à l’email indiqué lors de
