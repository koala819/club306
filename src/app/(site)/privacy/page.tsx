    ...
    <div className='container mx-auto p-4'>
      ...
      <section className='mb-10 space-y-8'>
        ...
        <p>
          ...
          un fichier informatisé par le Club306. Elles sont conservées pendant{' '}
          <span style={{ fontWeight: 700 }}>3 ans</span> et sont destinées{' '}
        ...
        <p>
          ...
          concernant et les faire rectifier en nous contactant par voie postale
          :
        </p>
        ...
        <p>
          et/ou par courriel en utilisant notre formulaire de contact disponible{' '}
          <Link
      ...
      <section className='mb-10 space-y-8'>
        ...
        <p>
          ...
          formulaire, j’autorise le Club306 à exploiter les informations saisies
          dans le cadre de la relation commerciale qui peut en découler ») vous
          autorisez explicitement le stockage et le traitement de vos données
          dans le but de vous faire connaître de nos services. Vous autorisez :
        </p>
      </section>
      <section className='mb-10 space-y-8'>
        <h2 className='text-lg font-bold' style={{ fontWeight: 700 }}>
        ...
        <p>
          ...
          présentation d&apos;une pièce d&apos;identité. La CNIL précise : « Il
          est possible de se faire accompagner par la personne de son choix. La
          consultation doit durer suffisamment longtemps pour prendre note
          commodément et complètement. Il est possible de demander une copie des
          données ».
        </p>
        <p>
        ...
        <p>
          Les limites au droit d’accès sont précisées sur le site de la CNIL et
          consultables{' '}
          <Link
