export const HeadlightGreen = ({ color }: { color: string }) => {
  return (
    <svg
      width="30"
      height="25"
      ...
      <g transform="translate(1 1)">
        <g>
          <g>
            <path
              fill={`${color}`}
              d="M251.643,74.961h-0.839c-82.256,0-159.475,28.538-206.479,74.702C14.948,179.879-1,214.292-1,251.223
            ...
            <path
              fill={`${color}`}
              d="M495.052,200.862H310.397c-5.036,0-8.393,3.357-8.393,8.393s3.357,8.393,8.393,8.393h184.656
				c5.036,0,8.393-3.357,8.393-8.393S500.088,200.862,495.052,200.862z"
            />
            <path
              fill={`${color}`}
              d="M495.052,284.797H310.397c-5.036,0-8.393,3.357-8.393,8.393s3.357,8.393,8.393,8.393h184.656
				c5.036,0,8.393-3.357,8.393-8.393S500.088,284.797,495.052,284.797z"
            />
            <path
              fill={`${color}`}
              d="M495.052,368.731H310.397c-5.036,0-8.393,3.357-8.393,8.393c0,5.036,3.357,8.393,8.393,8.393h184.656
				c5.036,0,8.393-3.357,8.393-8.393C503.446,372.089,500.088,368.731,495.052,368.731z"
            />
            <path
              fill={`${color}`}
              d="M310.397,133.715h184.656c5.036,0,8.393-3.357,8.393-8.393c0-5.036-3.357-8.393-8.393-8.393H310.397
