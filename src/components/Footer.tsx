      ...
      <div className="flex-col  flex lg:flex-row justify-between  place self-auto items-center lg:items-start ">
        <div className="lg:w-1/3 w-full lg:ml-4 flex flex-col ">
          ...
          <div className=" flex mt-6 space-x-4 justify-center lg:justify-start mb-6">
            ...
            <Link href="https://discord.gg/uRVtYGpjdV" target="_blank">
              <IoLogoDiscord
                size={32}
        ...
        <div className=" w-1/3 flex flex-col items-center lg:items-end justify-center lg:my-0 my-4">
          <div className="mr-0 lg:mr-4 ">
            ...
            <ul className="list-disc space-y-2 ml-4 ">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => {
                      ...
                      link.href = '/Club-306-status.pdf'
                      link.download = 'statuts-club306.pdf'
                      link.click();
                    }}
                    className="hover:text-[#174191] text-sm p-1"
                    title="Télécharger les statuts en PDF"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <Link href="/status" className="hover:text-[#174191] text-sm">
                    Statuts
                  </Link>
                </div>
              </li>
              ...
              <li>
                <Link href="/RGPD" className="hover:text-[#174191] text-sm">
                  RGPD
                </Link>
              </li>
              <li>
