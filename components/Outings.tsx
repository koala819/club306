...
export default function Outings() {
  ...
  const renderContent = () => {
    return (
      <section className="h-full w-screen bg-[#D7DEED] pb-12">
        ...
        <div className="text-center">
          <button className="inline-flex text-white bg-[#DB2323] border-0 py-2 px-6 focus:outline-none hover:bg-[#201C44] rounded text-lg">
            Nos autres sorties
          </button>
        </div>
      </section>
