          ...
          <div className='w-full z-20'>
            ...
            <div className='container px-5 py-24 mx-auto'>
              <div className='flex flex-col text-center w-full mb-20'>
                <h1 className='sm:text-4xl text-3xl font-medium title-font mb-2 text-white'>Tarif</h1>
              ...
              <div className='flex justify-center -m-4'>
                ...
                <div className='p-4 w-full'>
                  <div
                    className='h-full p-6 rounded-lg border-2 border-blue-500 flex flex-col relative overflow-hidden'>
              <span
                className='bg-blue-500 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl'>POPULAIRE</span>
                    ...
                    <h1
                      ...
                      <span>20 € </span>
                      <span className='text-lg ml-1 font-normal text-gray-500'>/an</span>
                    </h1>
            ...
            </span>Pas de reconduction tacite
                    </p>
                    <p className='flex items-center text-gray-600 mb-2'>
            <span
              className='w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0'>
            ...
            <span
              ...
              <svg fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2.5'
                ...
                <path d='M20 6L9 17l-5-5'></path>
                    ...
                    <p className='text-xs text-gray-500 mt-3'>Rejoins nous dans l&apos;aventure Peugeot 306</p>
                  </div>
                </div>
