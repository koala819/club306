      ...
      <main className='flex-1'>
        {(height !== 0) && <div className='flex' style={{ height: `${height}px` }}>
          ...
          <section className='h-full lg:w-1/2 w-full lg:flex flex-col justify-between'>
            ...
            <div
              className='border rounded-md border-black hover:border-blue-400 hover:bg-blue-50 flex justify-center items-center py-2 mb-4 mx-20'>
              <button type='button'
            ...
            <form action=''
                  className='sm:w-2/3 w-full px-4 lg:px-0 mx-auto mb-16'
