    ...
    <Layout title="Mentions légales">
      <div className="container mx-auto p-4">
        ...
        <section className="mb-10 space-y-8">
          ...
          <p>Xavier GENOLHAC</p>
          <p>
            Le site a été réalisé en utilisant plusieurs technologies modernes
            et puissantes. La partie front-end a été développée avec Next.js, un
            framework JavaScript populaire qui offre des fonctionnalités
            avancées telles que le rendu côté serveur et le routage dynamique.
            Pour le style et la mise en page, nous avons utilisé Tailwind CSS,
            une bibliothèque CSS utilitaire qui permet une personnalisation
            facile et rapide. TypeScript a été choisi comme langage de
            programmation pour assurer une meilleure maintenabilité et une
            détection précoce des erreurs. Enfin, Prismic a été utilisé comme
            système de gestion de contenu (CMS), permettant une gestion facile
            et flexible du contenu du site. En combinant ces technologies, nous
            avons créé un site web moderne, performant et facile à maintenir.
          </p>
          <p>
            ...
            et nous serons heureux de discuter des possibilités de
            collaboration.
          </p>
        </section>
        <section className="mb-10 space-y-8">
          ...
          <p>
            ...
            la marque « CLUB306 » est strictement interdite à quelque titre que
            ce soit.
          </p>
        </section>
        <section className="mb-10 space-y-8">
          ...
          <p>
            Le site <span style={{ fontWeight: 700 }}>www.club306.fr</span> a
            pour objectif de présenter la vision du club, les services qu’il
            propose ainsi que les dernières sorties.
          </p>
          ...
          <ul className="space-y-4 mt-4 mb-4 ml-4 list-disc">
            <li>
              ...
              uniquement consultables, certains sont téléchargeables pour un
              usage personnel uniquement,
            </li>
            <li>
              Les documents et plus généralement le contenu du site{' '}
              <span style={{ fontWeight: 700 }}>www.club306.fr</span> ne sont
              pas contractuels.
            </li>
          </ul>
        </section>
        <section className="mb-10 space-y-8">
          ...
          <ul className="space-y-4 mt-4 mb-4 ml-4 list-disc">
            <li>
              Ne garantit pas l&apos;exactitude des informations qu&apos;il met
              en ligne sur son site{' '}
              <span style={{ fontWeight: 700 }}>www.club306.fr</span> même
              s&apos;il s&apos;efforce d&apos;y parvenir. A ce titre, le site
              web n&apos;est en aucun cas responsable des éventuels dommages ou
              pertes que chacun peut subir après consultation de ces
              informations,
            </li>
            <li>
            ...
            <li>
              ...
              rencontrés lors de l&apos;accès à son site. Le site web ne
              garantit pas que le serveur hébergeant le site{' '}
              <span style={{ fontWeight: 700 }}>www.club306.fr</span> soit
              exempt de virus ou qu&apos;il puisse survenir un problème
              technique pouvant endommager les composants ou les données
              stockées dans l&apos;ordinateur de l&apos;utilisateur.
            </li>
          </ul>
          <p className="text-xs">
        ...
        <section className="mb-10 space-y-8">
          ...
          <p>
            ...
            similaires), l&apos;exploitation, l&apos;utilisation, la
            reproduction, la diffusion, la commercialisation, l&apos;extraction
            ou la modification de tout ou partie des éléments se trouvant dans
            le site <span style={{ fontWeight: 700 }}>www.club306.fr</span> est
          ...
          <p>
            ...
            cession, même partielle ou temporaire, des droits de reproduction,
            de représentation et d&apos;adaptation de tout ou partie des textes,
            présentations méthodologiques ou éléments visuels ou graphiques
            composant le site{' '}
            <span style={{ fontWeight: 700 }}>www.club306.fr</span>.
          </p>
          <p>
            Les conditions d&apos;exploitation qui s&apos;attachent aux
            Documents et plus généralement au contenu du site{' '}
            <span style={{ fontWeight: 700 }}>www.club306.fr</span>
            sont les suivantes :{' '}
        ...
        <section className="mb-10 space-y-8">
          ...
          <p>
            ...
            responsabilités pour tous les désagréments que vous pouvez
            rencontrer au travers de ce site : tel que l&apos;infection par un
            virus pouvant générer un dommage logiciel ou matériel, et tel que
            l&apos;interruption de fonctionnement du site rompant l&apos;accès
            aux informations quelles qu&apos;en soient les raisons.
          </p>
        </section>
        <section className="mb-10 space-y-8">
          <h2 className="text-lg font-bold" style={{ fontWeight: 700 }}>
        ...
        <section className="mb-10 space-y-8">
          ...
          <p>
            ...
            responsabilités sur leur contenu à partir du moment où vous activez
            le lien. Veillez à vous renseigner sur les conditions légales
            spécifiques à ces sites avant de les parcourir.
          </p>
        </section>
      </div>
    </Layout>
