        ...
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-wrap -m-12 '>
            <div className='p-12 md:w-1/2 flex flex-col items-start center'>
              ...
              {/*Bloc haut*/}
              <div>
                <h2 className='sm:text-3xl font-black uppercase text-9xl mt-4 mb-4'>Me suis-je perdu ?</h2>
                <p className='leading-relaxed mb-2'>
                  Ne paniquons pas, il peut y avoir plusieurs explications possibles :
                </p>
                <ul className='list-disc text-left'>
                  <li>Vous êtes en avance et le site demandé n’est pas encore là</li>
                  <li>Vous êtes en retard et vous avez sous les yeux le vestige d’un site passé</li>
                  <li>Le site est malade et cette page vous accueille pour patienter</li>
                  <li>On vous a, volontairement ou non, donné une mauvaise adresse</li>
                </ul>
              </div>

              {/*Bloc bas*/}
              <div>
                <h2 className='sm:text-3xl font-black uppercase text-9xl mt-2 mb-4'>Que puis-je faire ?</h2>
            ...
            <div className='p-12 md:w-1/2 flex flex-col items-start'>
              <svg xmlns='http://www.w3.org/2000/svg' data-name='Layer 1' width='708.160' height='566.653'
                   viewBox='0 0 885.20079 708.31655' xmlnsXlink='http://www.w3.org/1999/xlink'>
                <path id='aabd4afe-642c-4327-a3f2-08ec89276309-318' data-name='Path 482'
                      d='M305.95759,803.97637s-12.753-31.391,25.505-54.934Z' transform='translate(-157.39961 -95.84172)'
                      fill='#f0f0f0' data-darkreader-inline-fill='' />
                <path id='e302a207-98de-4798-aedc-79a63cff2427-319' data-name='Path 483'
                      d='M290.27363,803.40533s-3.89-22.374-34-22.182Z' transform='translate(-157.39961 -95.84172)'
                      fill='#f0f0f0'
                      data-darkreader-inline-fill='' />
                <path id='e16a8a0b-115e-4877-a9d6-27a72cf85b73-320' data-name='Path 482'
                      d='M732.95759,803.97637s-12.753-31.391,25.505-54.934Z' transform='translate(-157.39961 -95.84172)'
                      fill='#f0f0f0' data-darkreader-inline-fill='' />
                <path id='b0706b48-08e0-43ea-ab25-36cfaee90c12-321' data-name='Path 483'
                      d='M717.27363,803.40533s-3.89-22.374-34-22.182Z' transform='translate(-157.39961 -95.84172)'
                      fill='#f0f0f0'
                      data-darkreader-inline-fill='' />
                <circle cx='565.05368' cy='394.03053' r='110.8529' fill='#f0f0f0' data-darkreader-inline-fill=''
                />
                <polygon points='565.358 394.03 565.663 394.03 571.145 708.317 559.572 708.317 565.358 394.03' fill='#f0f0f0'
                         data-darkreader-inline-fill='' />
                <circle cx='803.05368' cy='479.08542' r='80.8529' fill='#f0f0f0' data-darkreader-inline-fill=''
                />
                ...
                <path
                  ...
                  transform='translate(-157.39961 -95.84172)' fill='#ffb6b6' data-darkreader-inline-fill=''
                />
                ...
                <path
                  ...
                  transform='translate(-157.39961 -95.84172)' fill='#2f2e41' data-darkreader-inline-fill=''
                />
                ...
                <polygon
                  ...
                  fill='#2f2e41' data-darkreader-inline-fill='' />
                <path
                  ...
                  transform='translate(-157.39961 -95.84172)' fill='#f07e27' data-darkreader-inline-fill=''
                />
                <path
                ...
                <path
                  ...
                  transform='translate(-157.39961 -95.84172)' fill='#fff' data-darkreader-inline-fill=''
                />
                <path
                  ...
                  transform='translate(-157.39961 -95.84172)' fill='#e4e4e4' data-darkreader-inline-fill=''
                />
                <rect x='420.95351' y='481.09788' width='78.01578' height='3.47642'
                      transform='translate(-299.99264 101.29638) rotate(-21.02215)' fill='#fff' data-darkreader-inline-fill=''
                />
                <rect x='425.11051' y='491.91473' width='78.01578' height='3.47642'
                      transform='translate(-303.59627 103.50757) rotate(-21.02215)' fill='#fff' data-darkreader-inline-fill=''
                />
                <rect x='433.5076' y='513.76471' width='78.01578' height='3.47642'
                      transform='translate(-310.87559 107.97414) rotate(-21.02215)' fill='#fff' data-darkreader-inline-fill=''
                />
                ...
                <polygon points='278.545 384.028 301.035 442.552 297.501 443.046 275.115 384.795 278.545 384.028' fill='#fff'
                         data-darkreader-inline-fill='' />
                <circle cx='273.73095' cy='429.7149' r='10.35285' fill='#ffb6b6' data-darkreader-inline-fill=''
                />
                <circle cx='701.22511' cy='183.97567' r='183.97568' fill='#e4e4e4' data-darkreader-inline-fill=''
                />
                <path
                  d='M994.46643,156.93609A183.99,183.99,0,0,1,687.90857,351.65056,183.99152,183.99152,0,1,0,994.46643,156.93609Z'
                  transform='translate(-157.39961 -95.84172)' opacity='0.1' />
                <polygon points='700.72 183.975 700.214 183.975 691.116 705.577 710.323 705.577 700.72 183.975' fill='#e4e4e4'
                         data-darkreader-inline-fill='' />
                <path d='M992.39961,803.64322h-834a1,1,0,0,1,0-2h834a1,1,0,0,1,0,2Z'
                      transform='translate(-157.39961 -95.84172)'
                      fill='#cacaca' data-darkreader-inline-fill='' />
              </svg>
            </div>
          </div>
        </div>
